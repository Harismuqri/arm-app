...
class XArmClickController:
    ...
    def __init__(self):
        ...
        print(f"  • Manual mode: Click without YOLO detection for simple inspection")
        print(f"  • Auto mode: YOLO detection provides object dimensions for smart positioning")
