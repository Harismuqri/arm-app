...
class RobotVisionGUI(QMainWindow):
    ...
    def apply_light_theme(self):
        """Apply light theme to the application - Windows 11 inspired"""
        self.setStyleSheet("""
            QMainWindow {
            ...
            QCheckBox::indicator:checked {
                ...
                border-color: #0078d4;
                image: url(data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMCIgaGVpZ2h0PSIxMCIgdmlld0JveD0iMCAwIDEwIDEwIj48cGF0aCBkPSJNOCAyTDQgOCAxIDUiIHN0cm9rZT0id2hpdGUiIHN0cm9rZS13aWR0aD0iMiIgZmlsbD0ibm9uZSIvPjwvc3ZnPg==);
            }
            QScrollBar:vertical {
                background-color: #f0f0f0;
                width: 12px;
    ...
    def apply_dark_theme(self):
        """Apply dark theme to the application - Windows 11 inspired"""
        self.setStyleSheet("""
            QMainWindow {
