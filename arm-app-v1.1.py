...
class RobotVisionGUI(QMainWindow):
    ...
    def apply_light_theme(self):
        """Apply light theme with proper text colors"""
        self.setStyleSheet("""
            QWidget { background-color: #f0f0f0; color: #000000; }
            QLabel { background-color: transparent; color: #000000; }
            QCheckBox { background-color: transparent; color: #000000; }
            QLineEdit, QTextEdit { background-color: #ffffff; border: 1px solid #c0c0c0; color: #000000; }
            QComboBox { background-color: #ffffff; border: 1px solid #c0c0c0; color: #000000; }
            QGroupBox { background-color: #ffffff; border: 1px solid #c0c0c0; color: #000000; }
            QTabWidget::pane { border: 1px solid #c0c0c0; background-color: #ffffff; }
            QTabBar::tab { background-color: #e0e0e0; border: 1px solid #c0c0c0; padding: 5px 10px; color: #000000; }
    ...
    def apply_dark_theme(self):
        ...
        self.setStyleSheet("""
            ...
            QLineEdit, QTextEdit { background-color: #2b2b2b; border: 1px solid #555555; color: #ffffff; }
            QComboBox { background-color: #2b2b2b; border: 1px solid #555555; color: #ffffff; }
            QGroupBox { background-color: #3c3c3c; border: 1px solid #555555; color: #ffffff; }
            QTabWidget::pane { border: 1px solid #555555; background-color: #3c3c3c; }
            QTabBar::tab { background-color: #2b2b2b; border: 1px solid #555555; padding: 5px 10px; color: #ffffff; }
